...
//! no - Music Importing
import nomusic1 from "./assets/AudioTracks/makeyou3.mp3";
import nomusic2 from "./assets/AudioTracks/untill.mp3";
import nomusic4 from "./assets/AudioTracks/tumsehi2.mp3";
import nomusic3 from "./assets/AudioTracks/khat.mp3";
...
export default function Page() {
  ...
  const getNoButtonText = () => {
    ...
    const phrases = [
      ...
      "Really sure?",
      "Think again!",
      "Ghumi Ghumi chalenge? 🥺",
      "Momos khilaunga to bhi nhi? 🥺",
      "puchiii dunga phir bhi nhi? 🥺",
      "Give it another thought!",
      "tumhara fav food bana ke khilaunga, tab bhi nhi? 🥺",
      "This could be a mistake!",
      "hugs and kisses waiting for you! 😘",
      "ab man bhi jao kammo ji..😫",
      "Is that your final answer?",
      "You're breaking my heart ;(",
      "But... why? 😢",
      "Please, pretty please? 💖",
      "I can't take this! 😫",
      "ab man bhi jao golu molu... 😫",
